                                    ...
                                    @foreach($transfer as $item)
                                        <tr class="odd">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="{{ route('admin.transferDetails', $item->id) }}" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" data-bs-toggle="tooltip" title="View User" data-bs-original-title="View">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
