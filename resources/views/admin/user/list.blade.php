        ...
        <div class="content">
            ...
            <div class="block block-rounded">
                ...
                <div class="block-content block-content-full">
                    <a href="{{ route('admin.add_user') }}" class="btn btn-primary mb-3">Create User</a>
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons dataTable no-footer" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                                    ...
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending">Balance</th>
