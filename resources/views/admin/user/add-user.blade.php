                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 space-y-2">
                            ...
                            <form class="row row-cols-lg-auto g-3 align-items-center" action="{{ route('admin.store_user') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-4">
                                    <label class="" for="example-if-name">First Name</label>
                                    <input  type="text" class="form-control form-control-alt" value="{{ old('first_name') }}"  id="example-if-name" name="first_name" >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-name">Last Name</label>
                                    <input  type="text" class="form-control form-control-alt" value="{{ old('last_name') }}" id="example-if-name" name="last_name" >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Email</label>
                                    <input  type="email" value="{{ old('email') }}" required class="form-control form-control-alt" id="example-if-email2" name="email" >
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input  type="tel" value="{{ old('phone') }}" required name="phone" class="form-control form-control-alt" id="example-if-phone"  >
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input  type="date" value="{{ old('date_of_birth') }}" name="date_of_birth" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <label class="" for="example-if-state">State</label>
                                    <input  type="text" name="state" value="{{ old('state') }}" class="form-control form-control-alt" id="example-if-state"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">City</label>
                                    <input type="text" name="city" class="form-control form-control-alt" value="{{ old('city') }}" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Address</label>
                                    <input  type="text" name="address" class="form-control form-control-alt" value="{{ old('address') }}" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Address 2</label>
                                    <input  type="text" name="address_2" class="form-control form-control-alt" value="{{ old('address_2') }}" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Zipcode</label>
                                    <input  type="text" name="zipcode" class="form-control form-control-alt" value="{{ old('zipcode') }}" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input   type="text" name="occupation" value="{{ old('occupation') }}" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Position</label>
                                    <input   type="text" name="position" value="{{ old('position') }}" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Employer Name</label>
                                    <input   type="text" name="employer_name" value="{{ old('employer_name') }}" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Office Address</label>
                                    <input   type="text" name="office_address" value="{{ old('office_address') }}" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Office Name</label>
                                    <input   type="text" name="office_name" value="{{ old('office_name') }}" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Annual Salary</label>
                                    <input   type="text" name="annual_salary" value="{{ old('annual_salary') }}" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-12">
                                    <div class="block-header block-header-default">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input   type="text" name="cus_idnumber" value="{{ old('cus_idnumber') }}" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
                                    <label class="" for="example-if-email2">Identification Expiry Date</label>
                                    <input   type="text" name="cus_expiry" value="{{ old('cus_expiry') }}" class="form-control form-control-alt" id="example-if-email2"  >
                                </div>
                                <div class="col-lg-4">
